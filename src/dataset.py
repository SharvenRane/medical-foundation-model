"""
Medical Foundation Model - Dataset
"""
import os
import torch
...
class MedicalFoundationModelDataset(Dataset):
    """Dataset for medical foundation model."""
...
def get_dataloader(root, split, config):
    ...
    dataset = MedicalFoundationModelDataset(root, split, transform)
    return DataLoader(
        dataset,
